...
- Visual Studio Code Marketplace: https://marketplace.visualstudio.com/items?itemName=oniro.oniro-ide
- Open VSX Registry (for VSCodium / compatible IDEs): https://open-vsx.org/extension/oniro/oniro-ide
